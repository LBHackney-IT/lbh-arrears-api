...
namespace ArrearsApi.Tests.V1.Gateways
{
    ...
    public class DynamoDbGatewayTests : DynamoDbIntegrationTests<Startup>
    {
        ...
        {
            var entity = _fixture.Build<EvictionsEntity>()
        ...
        private void InsertDatatoDynamoDB(EvictionsEntity entity)
        {
            DynamoDbContext.SaveAsync<EvictionsEntity>(entity).GetAwaiter().GetResult();
